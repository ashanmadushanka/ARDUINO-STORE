			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="DMBSTORES.php">Mother Boards</a></li>
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=1">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=3">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=4">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=5">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=6">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=7">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=8">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=9">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
