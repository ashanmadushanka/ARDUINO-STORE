			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li  class="active"><a href="DIOT.php">IOT</a></li>
						<li><a href="hotdeals.php"style="color: red;">HOT DEALS  <i class="fa fa-gift"  style="font-size:20px;color:red"></i></a></li>
						<li><a href="CHECKOUT.php?id=34"style="color: red;">Cart  <i class="fa fa-cart-arrow-down" style="font-size:20px;color:red"></i></i></a></li>
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-body">
										...
										<h3 class="product-name">ESP32 Development Board 2.4GHz WiFi+Bluetooth 38 Pins</h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<a href="Dpro.php?id=53">
									<div class="product-img">
										<img src="./Images/Products/p53/p531.jpg"  height="280" width="85" >
										<!-- <div class="product-label">
											<span class="new">NEW</span>
										</div> -->
									</div>
									<div class="product-body">
										<p class="product-category">IOT</p>
										<h3 class="product-name">16 Bit Analog to digital converter 4 channel Module (ADC) I2C ADS1115</h3>
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=53"> add to cart</a></button>
									</a>
									</div>	
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<a href="Dpro.php?id=53">
									<div class="product-img">
										<img src="./Images/Products/p54/p541.jpg"  height="280" width="85">
									</div>
									<div class="product-body">
										<p class="product-category">IOT</p>
										<h3 class="product-name">Focal Adjustable Night Vision Camera Module for Raspberry Pi</h3>
										<h4 class="product-price">LKR.3800.00</h4>
										<div class="product-rating">
										</div>
										<div class="product-btns">
											<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=4"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=5"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=6"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=7"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=8"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=9"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
