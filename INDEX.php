						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="IOT.php">IOT </a></li>
									<li><a data-toggle="tab" href="TOOLS.php">Tools</a></li>
									<li><a data-toggle="tab" href="MCSTORE.php">Modules & Sensors</a></li>
									<li><a data-toggle="tab" href="PA.php">Project Accessories</a></li>
								</ul>
							</div>
						</div>
					</div>
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											...
											<div class="add-to-cart">
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="sign.php"> add to cart
												</a>
											</button>
											</a>
											</div>
										...
										<div class="product">
											...
											<div class="add-to-cart">
												<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php"> add to cart</button></a>
											</div>
										</div>
										<!-- /product -->
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<a class="primary-btn cta-btn" href="sign.php">Shop now</a>
						</div>
					</div>
				</div>
				<!-- /row -->
