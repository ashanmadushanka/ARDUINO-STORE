			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li  class="active"><a href="DTOOLS.php">Tools</a></li>
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=42"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=43"> add to cart</a></button>
									</a>
									</div>	
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=44"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=45"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="CHECKOUT.php?id=49"> add to cart</a></button>
										</a>
									</div>
								</div>
							</div>
