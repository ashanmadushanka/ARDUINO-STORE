					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-img"  height="280" width="85">
										<img src="./Images/Products/MC/img1.jpg">
									...
									<div class="product-body">
										...
										<h3 class="product-name">Infrared PIR Motion Sensor Module HC-SR501</h3>
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=10">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-img">
										<img src="./Images/Products/MC/img2.jpg"  height="280" width="85" >
										<!-- <div class="product-label">
											<span class="new">NEW</span>
										</div> -->
									</div>
									<div class="product-body">
										<p class="product-category">Modules & Sensors</p>
										<h3 class="product-name">L293D Motor Driver Shield</h3>
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=11">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-img">
										<img src="./Images/Products/MC/img3.jpg"  height="280" width="85">
									</div>
									<div class="product-body">
										<p class="product-category">Modules & Sensors</p>
										<h3 class="product-name">Bluetooth Module HC-06</h3>
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=12">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-img">
										<img src="./Images/Products/MC/img4.jpg" height="280" width="85">
									</div>
									<div class="product-body">
										<p class="product-category">Modules & Sensors</p>
										<h3 class="product-name">Ethernet Module ENC28J60</h3>
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=13">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-img">
										<img src="./Images/Products/MC/img5.jpg" height="280" width="85">
										<div class="product-label">
											<span class="new">NEW</span>
										</div>
									</div>
									<div class="product-body">
										<p class="product-category">Modules & Sensors</p>
										<h3 class="product-name">RFID Card Reader/Writer RC522</h3>
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=14">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-img">
										<img src="./Images/Products/MC/img6.jpg" height="280" width="85">
										<div class="product-label">
											<span class="new">NEW</span>
										</div>
									</div>
									<div class="product-body">
										<p class="product-category">Modules & Sensors</p>
										<h3 class="product-name">NE555 Pulse Frequency Duty Cycle Adjustable Module</h3>
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=15">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									...
									<div class="product-img">
										<img src="./Images/Products/MC/img7.jpg" height="280" width="85">
										
									</div>
									<div class="product-body">
										<p class="product-category">Modules & Sensors</p>
										<h3 class="product-name">L298N Motor Driver</h3>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<a href="Dpro.php?id=17">
									<div class="product-img">
										<img src="./Images/Products/MC/img8.jpg" height="280" width="85">
										
									</div>
									<div class="product-body">
										<p class="product-category">Modules & Sensors</p>
										<h3 class="product-name">12v 1 channel relay module</h3>
										<h4 class="product-price">LKR.180.00</h4>
										<div class="product-rating">
										</div>
										<div class="product-btns">
											<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=17">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<a href="Dpro.php?id=18">
									<div class="product-img">
										<img src="./Images/Products/MC/img9.jpg" height="280" width="85">
										
									</div>
									<div class="product-body">
										<p class="product-category">Modules & Sensors</p>
										<h3 class="product-name">12V 10A 2 Channel Relay Module </h3>
										<h4 class="product-price">LKR.300.00</h4>
										<div class="product-rating">
										</div>
										<div class="product-btns">
											<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
									...
									<div class="add-to-cart"><a href="CHECKOUT.php?id=18">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button></a>
										</a>
									</div>
								</div>
						...
						<div class="store-filter clearfix">
							...
							<ul class="store-pagination">
								<li class="active"><a href="DMCSTORES.php">1</a></li>
								<li><a href="DMCSTORES2.php">2</a></li>
								<!-- <li><a href="#">3</a></li>
								<li><a href="#">4</a></li> -->
